...
class Main {
    ...
    */
    ...
    widenSelection() {
        ...
        this.textEditorStateByPath.get(filename).widenCurrentSelection();
    }

    narrowSelection() {
        const activeEditor = atom.workspace.getActiveTextEditor();
        const filename = activeEditor.getPath();
        this.textEditorStateByPath.get(filename).narrowCurrentSelection();
    }
    ...
    */
    ...
    addWatch = () => {
        const activeEditor = atom.workspace.getActiveTextEditor();
        this.textEditorStateByPath.get(activeEditor.getPath()).addWatchSelection();
    }
    ...
    initSubscriptions() {
        this.subscriptions.add(atom.workspace.observeTextEditors((textEditor) => {
            this.textEditorStateByPath.set(
                textEditor.getPath(),
                new TextEditorState(textEditor, this.sendMessage)
            );
        }));
    }
}
